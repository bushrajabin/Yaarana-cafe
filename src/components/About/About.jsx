...
import { images } from "../../CommonData/Data";
    ...
    <div>
      <div className=" w-full mt-20  xl:text-center xl:flex xl:flex-row xl:pt-16 xl:static">
        <img
          ...
          alt=""
          className=" hidden xl:block xl:h-80 xl:object-cover xl:absolute xl:-left-20 xl:top-2"
        />
        <div className=" text-center xl:flex xl:flex-col xl:justify-center xl:items-center">
          ...
          <div>
            <h1 className=" text-xl p-2 font-mono xl:font-thin xl:font-mono xl:p-3 xl:text-4xl ">
              ENJOY AN EXCEPTIONAL JOURNEY OF TASTE
            </h1>
          </div>

          <div>
            <p className=" text-sm font-serif p-1 xl:text-sm xl:p-5 xl:font-bold xl:text-gray-600">
            ...
            <p className="  text-sm p-2 font-semibold xl:text-sm xl:font-bold xl:text-gray-600 xl:m-0 xl:pl-40 xl:pr-40 ">
          ...
          <div className=" xl:w-40  xl:m-4 xl:items-center xl:mt-10">
            <button
              onClick={goToTable}
              className=" p-3 w-26 m-3 border-2 border-black hover:bg-black hover:text-white  xl:border-2 xl:border-black xl:p-3 xl:m-1 xl:w-40 xl:hover:transition-all xl:duration-500 xl:hover:bg-black xl:hover:text-cyan-50"
            >
              BOOK A TABLE
            </button>
          </div>
      ...
      <button className="p-3 w-26 m-auto flex flex-col justify-center border-2 border-black hover:bg-black hover:text-white  xl:border-2 xl:border-black xl:p-3 xl:m-1 xl:w-40 xl:hover:transition-all xl:duration-500 xl:hover:bg-black xl:hover:text-cyan-50 xl:items-center ">
        BLOG
      </button>
    </div>
  );
